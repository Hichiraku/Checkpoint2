...
foreach ($User in $Users)
{
    ...
    If (-not(Get-LocalUser -Name $Name -ErrorAction SilentlyContinue))
    {
        ...
        Write-Host "L'utilisateur $Name a été crée" -ForegroundColor Green
        Write-Host "Son mot de passe est $Pass" -ForegroundColor Green
        Log  -FilePath $LogFile -Content "L'utilisateur $Name a été crée"
    }
    else
    {
